    ...
    var gather = {
            ...
            var log = {}, mod = {
                picture: function (editor) { //插入图片
                    layer.open({
                        ...
                        , content: ['<ul class="layui-form layui-form-pane" style="margin: 20px;"></ul>'
        ...
        , cookie: function (e, o, t) {
            ...
            if ("undefined" == typeof o) {
                if (p = null, document.cookie && "" != document.cookie) for (s = document.cookie.split(";"), d = 0; d < s.length; d++) if (u = $.trim(s[d]), u.substring(0, e.length + 1) == e + "=") {
